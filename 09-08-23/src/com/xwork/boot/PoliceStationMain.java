...
import com.xwork.app.FireStation;
import com.xwork.app.PoliceStation;
...
public class PoliceStationMain {
	public static void main(String[] args) {
		...
		policeStation1.station("Pinya station");
		policeStation1.station("Pinya station","magadi");
		policeStation1.station("Pinya station","magadi",30);
		policeStation1.station("Pinya station","magadi",30,"Karnataka");
		policeStation1.station("Pinya station","magadi",30,"Karnataka",true);
