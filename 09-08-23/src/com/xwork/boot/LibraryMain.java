...
import in.examples.overload_override.app.Library;
import in.examples.overload_override.app.PublicLibrary;

public class LibraryMain {
	public static void main(String[] args) {
		System.out.println("\n-------printing overload methods in parent class------------------\n");

		com.xwork.app.Library library=new Library();
		library.bookStore();
		...
		com.xwork.app.Library library2=new PublicLibrary();
		library2.bookStore();
		...
		com.xwork.app.PublicLibrary library3=new PublicLibrary();
		library3.bookStore();
